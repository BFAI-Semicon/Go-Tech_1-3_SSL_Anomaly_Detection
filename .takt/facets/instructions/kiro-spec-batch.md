...
- `tasks.md` が存在するだけで skip しない。`spec.json.phase` が `tasks-generated` または後続の `implemented`、requirements/design/tasks approvals、`ready_for_implementation == true`、required artifacts の存在を readiness evidence として確認する。
